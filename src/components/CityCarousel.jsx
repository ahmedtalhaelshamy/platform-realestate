...
export default function CityCarousel({ lang }) {
  ...
  // 1. Fetching Data with Project Count
  useEffect(() => {
  ...
  const scroll = useCallback((direction) => {
    if (scrollRef.current) {
      ...
      const scrollWidth = container.offsetWidth * 0.8; // سكرول بنسبة 80% من عرض الشاشة
  ...
  return (
    <section className="py-24 md:py-32 bg-white border-t border-slate-50 font-sans overflow-hidden" aria-label="Locations Carousel">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 italic uppercase leading-[0.9] tracking-tighter">
        ...
        >
          {locations.map((city) => (
            ...
            >
              {/* Image Layer with Parallax Effect on Hover */}
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-10 z-10">
                ...
                <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-700 delay-100">
                    ...
                    <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-950 shadow-lg">
