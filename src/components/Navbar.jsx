    ...
    <>
          ...
          <div className="flex justify-between items-center h-full">
            ...
            <div className="hidden lg:flex items-center justify-center flex-1 gap-8 xl:gap-10">
              ...
              <div className="relative group h-10 flex items-center"> 
                <button 
                  aria-expanded="false"
                  className={`flex items-center gap-1 font-bold text-[15px] transition-colors ${textColor} ${pathname.includes('locations') ? '!text-[#C02026] font-black' : ''}`}
                >
            ...
            <div className="hidden lg:flex items-center justify-end gap-3 shrink-0">
              <Link 
                ...
                className={`flex items-center gap-1.5 px-3 py-2 rounded-lg transition-colors group ${textColor}`}
              >
      ...
      >
        ...
        <div className="p-6 flex items-center justify-between border-b border-gray-50">
          <div className="relative w-24 h-10"><Image src="/logo.png" alt="Platform Logo" fill className="object-contain" /></div>
          <button 
            onClick={closeMenu} 
            aria-label={isAr ? "إغلاق القائمة" : "Close Menu"}
            className="p-2 bg-gray-50 rounded-full text-slate-500 hover:bg-red-50 hover:text-[#C02026] transition-colors"
          >
            <X size={24}/>
          </button>
        </div>
          ...
          <nav className="space-y-2 text-start pb-20"> 
            ...
            <div className="space-y-1">
              <button 
                ...
                aria-label={isAr ? "فتح قائمة المشاريع" : "Expand Projects"}
        ...
        <div className="p-6 border-t border-gray-50 bg-gray-50/50 space-y-4">
          <Link href={switchLangPath} aria-label={isAr ? "Switch to English" : "العربية"} className="flex items-center justify-center gap-2 w-full py-3 bg-white border border-gray-200 rounded-xl text-sm font-black text-gray-700 shadow-sm active:scale-95 transition-transform">
